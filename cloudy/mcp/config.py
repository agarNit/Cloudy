...
def load_cloudy_mcp_configs() -> dict:
 """Return mcp_servers dict from servers.json with env vars resolved.


 CWD is injected at load time so ${CWD} in the config always resolves to the
 directory where cloudy was launched — not the package install location.
 """
